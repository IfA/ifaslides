%!TEX spellcheck = de
\documentclass[german,aspectratio=169,notoc,titlestyle=white,structurestyle=white]{tudbeamer}%note: when switching to the tud titlestyle, an additional build is needed
