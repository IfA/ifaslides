%!TEX spellcheck = de
\documentclass[german,aspectratio=169]{tudbeamer}%note: when switching to the tud titlestyle, an additional build is needed
	%,titlestyle=tud,structureframestyle=white
