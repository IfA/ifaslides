%!TEX spellcheck = de
\documentclass[german,aspectratio=169,titlestyle=white]{tudbeamer}

%\setlength{\headernavigationwidthskip}{1.2 cm}
...
\affiliation{Fakultät Elektrotechnik und Informationstechnik $\bullet$ Institut für Automatisierungstechnik}
